...
class AttendanceClalenderPage extends StatefulWidget {
  ...
  const AttendanceClalenderPage({super.key, required this.absenceDaysPerMonth});
              ...
              Expanded(
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    bool isOutOfRange =
                        thisDay.isBefore(startDate) || thisDay.isAfter(endDate);
                    ...
                    return Container(
                      decoration: BoxDecoration(
                        color:
                            isOutOfRange ? Colors.grey.shade200 : Colors.white,
                          ...
                          Positioned(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 12,
                                color:
                                    isOutOfRange ? Colors.grey : Colors.black,
                              ),
                            ),
                          ),
